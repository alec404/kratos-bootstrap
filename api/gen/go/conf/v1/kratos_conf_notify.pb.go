...
const file_conf_v1_kratos_conf_notify_proto_rawDesc = "" +
	"\n" +
	" conf/v1/kratos_conf_notify.proto\x12\aconf.v1\"\x87\x01\n" +
	"\fNotification\x12\x16\n" +
	"\x06enable\x18\x01 \x01(\bR\x06enable\x12;\n" +
	"\tding_talk\x18\x02 \x01(\v2\x1e.conf.v1.Notification.DingTalkR\bdingTalk\x1a\"\n" +
	"\bDingTalk\x12\x16\n" +
	"\x06tokens\x18\x01 \x03(\tR\x06tokensB?Z=github.com/alec404/kratos-bootstrap/api/gen/go/conf/v1;confv1b\x06proto3"
