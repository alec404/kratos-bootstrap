...
const file_conf_v1_kratos_conf_bootstrap_proto_rawDesc = "" +
	"\n" +
	"#conf/v1/kratos_conf_bootstrap.proto\x12\aconf.v1\x1a conf/v1/kratos_conf_tracer.proto\x1a\x1econf/v1/kratos_conf_data.proto\x1a conf/v1/kratos_conf_server.proto\x1a conf/v1/kratos_conf_client.proto\x1a conf/v1/kratos_conf_logger.proto\x1a conf/v1/kratos_conf_notify.proto\x1a!conf/v1/kratos_conf_metrics.proto\"\xab\x02\n" +
	"\tBootstrap\x12'\n" +
	"\x06server\x18\x01 \x01(\v2\x0f.conf.v1.ServerR\x06server\x12'\n" +
	"\x06client\x18\x02 \x01(\v2\x0f.conf.v1.ClientR\x06client\x12!\n" +
	"\x04data\x18\x03 \x01(\v2\r.conf.v1.DataR\x04data\x12%\n" +
	"\x05trace\x18\x04 \x01(\v2\x0f.conf.v1.TracerR\x05trace\x12'\n" +
	"\x06logger\x18\x05 \x01(\v2\x0f.conf.v1.LoggerR\x06logger\x12-\n" +
	"\x06notify\x18\t \x01(\v2\x15.conf.v1.NotificationR\x06notify\x12*\n" +
	"\ametrics\x18\n" +
	" \x01(\v2\x10.conf.v1.MetricsR\ametricsB?Z=github.com/alec404/kratos-bootstrap/api/gen/go/conf/v1;confv1b\x06proto3"
