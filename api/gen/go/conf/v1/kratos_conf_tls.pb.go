...
type TLS struct {
	...
	File               *TLS_File              `protobuf:"bytes,1,opt,name=file,proto3,oneof" json:"file,omitempty"`                                                    // 文件路径形式的TLS配置
	Config             *TLS_Config            `protobuf:"bytes,2,opt,name=config,proto3,oneof" json:"config,omitempty"`                                                // PEM内容形式的TLS配置
	InsecureSkipVerify bool                   `protobuf:"varint,3,opt,name=insecure_skip_verify,json=insecureSkipVerify,proto3" json:"insecure_skip_verify,omitempty"` // 是否跳过服务端证书校验
...
type TLS_File struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CertPath      *string                `protobuf:"bytes,1,opt,name=cert_path,json=certPath,proto3,oneof" json:"cert_path,omitempty"` // 客户端证书文件路径
	KeyPath       *string                `protobuf:"bytes,2,opt,name=key_path,json=keyPath,proto3,oneof" json:"key_path,omitempty"`    // 客户端私钥文件路径
...
type TLS_Config struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CertPem       []byte                 `protobuf:"bytes,1,opt,name=cert_pem,json=certPem,proto3,oneof" json:"cert_pem,omitempty"` // 客户端证书PEM
	KeyPem        []byte                 `protobuf:"bytes,2,opt,name=key_pem,json=keyPem,proto3,oneof" json:"key_pem,omitempty"`    // 客户端私钥PEM
	CaPem         []byte                 `protobuf:"bytes,3,opt,name=ca_pem,json=caPem,proto3,oneof" json:"ca_pem,omitempty"`       // CA证书PEM
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_conf_v1_kratos_conf_tls_proto_rawDesc = "" +
	...
	"\a_ca_pemB\a\n" +
	"\x05_fileB\t\n" +
	"\a_configB?Z=github.com/alec404/kratos-bootstrap/api/gen/go/conf/v1;confv1b\x06proto3"
