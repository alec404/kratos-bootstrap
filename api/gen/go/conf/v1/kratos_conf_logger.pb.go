...
const file_conf_v1_kratos_conf_logger_proto_rawDesc = "" +
	"\n" +
	" conf/v1/kratos_conf_logger.proto\x12\aconf.v1\"\x96\x03\n" +
	"\x06Logger\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12%\n" +
	"\x03zap\x18\x02 \x01(\v2\x13.conf.v1.Logger.ZapR\x03zap\x1a\xd0\x02\n" +
	"\x03Zap\x12%\n" +
	"\x0eenable_console\x18\x01 \x01(\bR\renableConsole\x12\x1f\n" +
	"\venable_file\x18\x02 \x01(\bR\n" +
	"enableFile\x12*\n" +
	"\x11enable_error_file\x18\x03 \x01(\bR\x0fenableErrorFile\x12\x1a\n" +
	"\bfilename\x18\x04 \x01(\tR\bfilename\x12%\n" +
	"\x0eerror_filename\x18\x05 \x01(\tR\rerrorFilename\x12\x14\n" +
	...
	"maxBackups\x12'\n" +
	"\x0fenable_compress\x18\n" +
	" \x01(\bR\x0eenableCompressB?Z=github.com/alec404/kratos-bootstrap/api/gen/go/conf/v1;confv1b\x06proto3"
